package com.bananac.framework.user.web.taglib;

import java.util.Collection;

import org.springframework.util.CollectionUtils;

import com.bananac.framework.core.util.SpringUtil;
import com.bananac.framework.user.entity.Organization;
import com.bananac.framework.user.entity.Resource;
import com.bananac.framework.user.entity.Role;
import com.bananac.framework.user.service.OrganizationService;
import com.bananac.framework.user.service.ResourceService;
import com.bananac.framework.user.service.RoleService;
...
public class Functions {
    ...
    public static ResourceService getResourceService() {
        if(resourceService == null) {
            resourceService = SpringUtil.getBean(ResourceService.class);
        }
